...
"color: rgb(255, 255, 255);")
        ...
        self.filemenu.addAction(self.actionGoto)
...
#endif // QT_CONFIG(shortcut)
        self.actionGoto.setText(QCoreApplication.translate("MainWindow", u"Go To Question", None))
#if QT_CONFIG(shortcut)
        self.actionGoto.setShortcut(QCoreApplication.translate("MainWindow", u"G", None))
#endif // QT_CONFIG(shortcut)
